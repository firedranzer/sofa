...
namespace sofa
{
	namespace core
	{
		...
		namespace collision
		{
            ...
            template<class T>
            bool ContactListener::canCreate(T*& obj, core::objectmodel::BaseContext* context, core::objectmodel::BaseObjectDescription* arg)
            {
            ...
            template<class T>
            typename T::SPtr ContactListener::create(T* , core::objectmodel::BaseContext* context, core::objectmodel::BaseObjectDescription* arg)
            {
