...
template <class In, class Out>
template<class T>
bool Mapping<In,Out>::canCreate(T*& obj, core::objectmodel::BaseContext* context, core::objectmodel::BaseObjectDescription* arg)
{
    State<In>* stin = NULL;
...
template <class In, class Out>
template<class T>
typename T::SPtr Mapping<In,Out>::create(T*, core::objectmodel::BaseContext* context, core::objectmodel::BaseObjectDescription* arg)
{
