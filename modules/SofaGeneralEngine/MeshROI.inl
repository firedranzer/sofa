...
template <class DataTypes>
template<class T>
bool MeshROI<DataTypes>::canCreate(T*& obj, core::objectmodel::BaseContext* context, core::objectmodel::BaseObjectDescription* arg)
{
...
template <class DataTypes>
template<class T>
typename T::SPtr MeshROI<DataTypes>::create(T* tObj, core::objectmodel::BaseContext* context, core::objectmodel::BaseObjectDescription* arg)
{
