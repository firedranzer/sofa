...
void initExternalModule()
{
    ...
    PluginManager::getInstance().loadPlugin("SoftRobots.ForceFields") ;
    PluginManager::getInstance().loadPlugin("SoftRobots.Actuators") ;
}
...
{
    return "This package expose all the SoftRobots component.";
}
