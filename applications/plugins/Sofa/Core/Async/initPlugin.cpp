...
extern "C" {
    SOFA_CORE_ASYNC_API void initExternalModule();
    SOFA_CORE_ASYNC_API const char* getModuleName();
    SOFA_CORE_ASYNC_API const char* getModuleVersion();
    SOFA_CORE_ASYNC_API const char* getModuleLicense();
    SOFA_CORE_ASYNC_API const char* getModuleDescription();
    SOFA_CORE_ASYNC_API const char* getModuleComponentList();
}
...
{
    return "The module implements asynchronous mechanism.";
}
