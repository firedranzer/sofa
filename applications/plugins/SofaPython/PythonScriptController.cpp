...
#define BIND_CONTROLLER_METHOD(funcName) BIND_OBJECT_METHOD(m_ScriptControllerInstance,m_Func_##funcName,PythonScriptController,m_ScriptControllerClass,#funcName)

void PythonScriptController::refreshBinding()
{
    BIND_CONTROLLER_METHOD(onLoaded)
    BIND_CONTROLLER_METHOD(createGraph)
    BIND_CONTROLLER_METHOD(initGraph)
    BIND_CONTROLLER_METHOD(bwdInitGraph)
    BIND_CONTROLLER_METHOD(onKeyPressed)
    BIND_CONTROLLER_METHOD(onKeyReleased)
    BIND_CONTROLLER_METHOD(onMouseButtonLeft)
    BIND_CONTROLLER_METHOD(onMouseButtonRight)
    BIND_CONTROLLER_METHOD(onMouseButtonMiddle)
    BIND_CONTROLLER_METHOD(onMouseWheel)
    BIND_CONTROLLER_METHOD(onBeginAnimationStep)
    BIND_CONTROLLER_METHOD(onEndAnimationStep)
    BIND_CONTROLLER_METHOD(storeResetState)
    BIND_CONTROLLER_METHOD(reset)
    BIND_CONTROLLER_METHOD(cleanup)
    BIND_CONTROLLER_METHOD(onGUIEvent)
    BIND_CONTROLLER_METHOD(onScriptEvent)
    BIND_CONTROLLER_METHOD(draw)
    BIND_CONTROLLER_METHOD(onIdle)
}
