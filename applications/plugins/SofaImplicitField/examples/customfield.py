...
def evalField(x,y,z):
        ...
        return f.eval(x,y,z)
        #return min(((1.0*(1.0*(x-0.0)-0.0*(y-0.0))-0.0*(z-0.0))/1.0)*((1.0*(1.0*(x-0.0)-0.0*(y-0.0))-0.0*(z-0.0))/1.0)+((0.0*(x-0.0)+1.0*(y-0.0))/1.0)*((0.0*(x-0.0)+1.0*(y-0.0))/1.0)+((0.0*(1.0*(x-0.0)-0.0*(y-0.0))+1.0*(z-0.0))/1.0)*((0.0*(1.0*(x-0.0)-0.0*(y-0.0))+1.0*(z-0.0))/1.0)-1.0,((1.0*(1.0*(x-1.0)-0.0*(y-0.0))-0.0*(z-0.0))/1.0)*((1.0*(1.0*(x-1.0)-0.0*(y-0.0))-0.0*(z-0.0))/1.0)+((0.0*(x-1.0)+1.0*(y-0.0))/1.0)*((0.0*(x-1.0)+1.0*(y-0.0))/1.0)+((0.0*(1.0*(x-1.0)-0.0*(y-0.0))+1.0*(z-0.0))/1.0)*((0.0*(1.0*(x-1.0)-0.0*(y-0.0))+1.0*(z-0.0))/1.0)-1.0)
